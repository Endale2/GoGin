...
// RunSeed inserts sample users and vents into the DB. Intended to be called
// from a small main wrapper or used programmatically in tests.
func RunSeed() {
	...
	for i := 0; i < 10; i++ {
		...
		if _, err := ventCol.InsertOne(ctx, v); err != nil {
